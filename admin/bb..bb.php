...
if (isset($_GET['type']) && $_GET['type'] != '') {
  ...
  if ($type == 'deactive') {
    ...
    mysqli_query($con, "update upload set status=0 where id='$id' ");
    redirect('bb..bb.php');
  }
  ...
  if ($type == 'active') {
    ...
    mysqli_query($con, "update upload set status=1 where id='$id' ");
    redirect('bb..bb.php');
  }
}
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td width="30px"><img src="<?php echo FILE_SITE_PATH . $row['image'] ?>" style="width: 70%; height: 30px;"></td>
                          <td>
