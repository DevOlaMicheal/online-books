...
if (isset($_GET['type']) && $_GET['type'] != '') {
  ...
  if ($type == 'delete') {
    ...
    mysqli_query($con, "delete from uploaded_videos where id='$id' ");
    redirect('bb..bb.php');
  }
  ...
  if ($type == 'deactive') {
    ...
    mysqli_query($con, "update uploaded_videos set status=0 where id='$id' ");
    redirect('bb..bb.php');
  }
  ...
  if ($type == 'active') {
    ...
    mysqli_query($con, "update uploaded_videos set status=1 where id='$id' ");
    redirect('bb..bb.php');
  }
}
