...
require 'header.php';
$res = mysqli_query($con, "select * from upload where department='COMPUTER SCIENCE' order by id desc");
      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Computer Science</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
              ...
              <div class="col-12 my-5">
                <nav aria-label="Page Navigation">
                  <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item">
                      <a class="page-link" href="#"> <?php echo $no_cs ?></a>
                    </li>
