...
require 'header.php';
$res = mysqli_query($con, "select * from upload where department='FOT' order by id desc");
      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Forestry Technology</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
            ...
            <?php
              ...
              <div class="col-12 my-5">
                <nav aria-label="Page Navigation">
                  ...
                  <li class="page-item">
                      <a class="page-link" href="#"> <?php echo $no_fot ?></a>
                    </li>
