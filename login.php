...
if(isset($_POST['submit'])){
    ...
    $res=mysqli_query($con,"select * from student_users where mat_no='$mat_no' and password='$password' ");
    ...
    if($cc>0){
      ...
      $row=mysqli_fetch_assoc($res);
          if($row['status']==0){
              ...
              $_SESSION['STUDENT_USER_NAME']=$row['first_name'];
...
<body class="hold-transition login-page" style="background-image: url('assets/assets/img/alexandra-fuller-wkgv7I2VTzM-unsplash.jpg'); background-size: cover; background-position: center;">
<div class="login-box">
  <!-- /.login-logo -->
    ...
    <div class="card-body">
      ...
      <form method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="mat_no" placeholder="Mat No">
